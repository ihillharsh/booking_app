...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFF2591C3);
  ...
  static const Color chipSelected = Color(0xFF00BCD4);

  // Discount/Offer
  static const Color discountBegin = Color(0xFF6080DF);
  static const Color discountEnd = Color(0xFFA70190);
